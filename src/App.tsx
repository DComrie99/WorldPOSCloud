...
function Logo({ compact = false }: { compact?: boolean }) { return <div className={compact ? "logo compact" : "logo"}><span className="logo-mark"><i /><i /><i /></span><span><strong>WorldPOS</strong><small>Cloud</small></span></div>; }
